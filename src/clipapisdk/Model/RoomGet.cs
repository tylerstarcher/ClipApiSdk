...
namespace clipapisdk.Model
{
    ...
    /// RoomGet
    /// </summary>
    [DataContract(Name = "RoomGet")]
    public partial class RoomGet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoomGet" /> class.
        /// </summary>
        ...
        public RoomGet(string type = default(string), string id = default(string), string idV1 = default(string), List<ResourceIdentifier> children = default(List<ResourceIdentifier>), List<ResourceIdentifier> services = default(List<ResourceIdentifier>), RoomGetAllOfMetadata metadata = default(RoomGetAllOfMetadata))
        {
            this.Type = type;
            this.Id = id;
            this.IdV1 = idV1;
