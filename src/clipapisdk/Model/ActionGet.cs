...
namespace clipapisdk.Model
{
    ...
    /// ActionGet
    /// </summary>
    [DataContract(Name = "ActionGet")]
    public partial class ActionGet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionGet" /> class.
        /// </summary>
        ...
        public ActionGet(string type = default(string), string id = default(string), string idV1 = default(string), ResourceIdentifier owner = default(ResourceIdentifier), Object target = default(Object), ActionGetAllOfAction action = default(ActionGetAllOfAction))
        {
            this.Type = type;
            this.Id = id;
            this.IdV1 = idV1;
        ...
        public ActionGetAllOfAction Action { get; set; }
