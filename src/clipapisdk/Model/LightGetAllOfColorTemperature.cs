...
namespace clipapisdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LightGet_allOf_color_temperature")]
    public partial class LightGetAllOfColorTemperature : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LightGetAllOfColorTemperature" /> class.
        /// </summary>
        /// <param name="mirek">color temperature in mirek or null when the light color is not in the ct spectrum.</param>
        /// <param name="mirekValid">Indication whether the value presented in mirek is valid.</param>
        /// <param name="mirekSchema">mirekSchema.</param>
        public LightGetAllOfColorTemperature(int mirek = default(int), bool mirekValid = default(bool), LightGetAllOfColorTemperatureMirekSchema mirekSchema = default(LightGetAllOfColorTemperatureMirekSchema))
        {
            this.Mirek = mirek;
            this.MirekValid = mirekValid;
        ...
        [DataMember(Name = "mirek_valid", EmitDefaultValue = true)]
        public bool MirekValid { get; set; }

        /// <summary>
        /// Gets or Sets MirekSchema
        /// </summary>
        [DataMember(Name = "mirek_schema", EmitDefaultValue = false)]
        public LightGetAllOfColorTemperatureMirekSchema MirekSchema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LightGetAllOfColorTemperature {\n");
            sb.Append("  Mirek: ").Append(Mirek).Append("\n");
            sb.Append("  MirekValid: ").Append(MirekValid).Append("\n");
            sb.Append("  MirekSchema: ").Append(MirekSchema).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
