...
namespace clipapisdk.Model
{
    ...
    /// ColorTemperature
    /// </summary>
    [DataContract(Name = "ColorTemperature")]
    public partial class ColorTemperature : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ColorTemperature" /> class.
        /// </summary>
        /// <param name="mirek">color temperature in mirek or null when the light color is not in the ct spectrum.</param>
        public ColorTemperature(int mirek = default(int))
        {
            this.Mirek = mirek;
        }
