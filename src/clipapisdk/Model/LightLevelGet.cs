...
namespace clipapisdk.Model
{
    ...
    /// LightLevelGet
    /// </summary>
    [DataContract(Name = "LightLevelGet")]
    public partial class LightLevelGet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LightLevelGet" /> class.
        /// </summary>
        ...
        public LightLevelGet(string type = default(string), string id = default(string), string idV1 = default(string), ResourceIdentifier owner = default(ResourceIdentifier), bool enabled = default(bool), LightLevelGetAllOfLight light = default(LightLevelGetAllOfLight))
        {
            this.Type = type;
            this.Id = id;
            this.IdV1 = idV1;
        ...
        public LightLevelGetAllOfLight Light { get; set; }
