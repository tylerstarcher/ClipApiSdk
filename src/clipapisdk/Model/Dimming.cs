...
namespace clipapisdk.Model
{
    ...
    /// Dimming
    /// </summary>
    [DataContract(Name = "Dimming")]
    public partial class Dimming : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Dimming" /> class.
        /// </summary>
        /// <param name="brightness">Brightness percentage. value cannot be 0, writing 0 changes it to lowest possible brightness.</param>
        public Dimming(decimal brightness = default(decimal))
        {
