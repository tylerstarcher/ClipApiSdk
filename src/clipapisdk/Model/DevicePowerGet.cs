...
namespace clipapisdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DevicePowerGet")]
    public partial class DevicePowerGet : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DevicePowerGet" /> class.
        /// </summary>
        ...
        /// <param name="powerState">powerState.</param>
        public DevicePowerGet(string type = default(string), string id = default(string), string idV1 = default(string), ResourceIdentifier owner = default(ResourceIdentifier), DevicePowerGetAllOfPowerState powerState = default(DevicePowerGetAllOfPowerState))
        {
            this.Type = type;
            this.Id = id;
            this.IdV1 = idV1;
        ...
        public DevicePowerGetAllOfPowerState PowerState { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DevicePowerGet {\n");
