...
namespace clipapisdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceOwned")]
    public partial class ResourceOwned : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceOwned" /> class.
        /// </summary>
        ...
        public ResourceOwned(string type = default(string), string id = default(string), string idV1 = default(string), ResourceIdentifier owner = default(ResourceIdentifier))
        {
            this.Type = type;
            this.Id = id;
            this.IdV1 = idV1;
