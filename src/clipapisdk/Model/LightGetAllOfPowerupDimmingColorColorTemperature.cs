...
namespace clipapisdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LightGet_allOf_powerup_dimming_color_color_temperature")]
    public partial class LightGetAllOfPowerupDimmingColorColorTemperature : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LightGetAllOfPowerupDimmingColorColorTemperature" /> class.
        /// </summary>
        /// <param name="mirek">color temperature in mirek or null when the light color is not in the ct spectrum.</param>
        /// <param name="color">color.</param>
        public LightGetAllOfPowerupDimmingColorColorTemperature(int mirek = default(int), Color color = default(Color))
        {
            this.Mirek = mirek;
            this.Color = color;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LightGetAllOfPowerupDimmingColorColorTemperature {\n");
