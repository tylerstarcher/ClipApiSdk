...
namespace clipapisdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Effects")]
    public partial class Effects : IValidatableObject
    {
        ...
        public Effects(SupportedEffects? effect = default(SupportedEffects?))
        {
            this.Effect = effect;
        }
