...
namespace clipapisdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Powerup")]
    public partial class Powerup : IValidatableObject
    {
        /// <summary>
        ...
        public Powerup(PresetEnum? preset = default(PresetEnum?), bool configured = default(bool), LightGetAllOfPowerupOn on = default(LightGetAllOfPowerupOn), PowerupDimming dimming = default(PowerupDimming))
        {
            this.Preset = preset;
