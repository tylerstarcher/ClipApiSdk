...
namespace clipapisdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
                    ...
                    new Dictionary<string, object> {
                        ...
                        {"description", "Your Home Bridge"},
                        {
                            "variables", new Dictionary<string, object> {
                                {
                                    "bridgeInternalIPAddress", new Dictionary<string, object> {
                                        {"description", "Use the broker server discover process by visiting https://discovery.meethue.com to discover the IP address of the bridge on your network "},
        ...
        public Configuration(
            ...
            string basePath = "https://192.168.1.0") : this()
        {
        ...
        {
            string report = "C# SDK (clipapisdk) Debug Report:\n";
